...
const RoleEdit = () => {
    ...
    <div class="m-4">
      <a type="button" className="btn btn-primary" onClick={handleSave}>Submit</a>
      <a type="button" className="btn btn-primary" onClick={() => navigate(`/roles/${roleSelect.id}`)}>Cancel</a>
      </div>
    </Form>
  )
}
